...
<c:import url="../layout/app.jsp">
 ...
 <c:choose>
        ...
        <p>Create date(作成日時)：<fmt:formatDate value="${task.created_at}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
        <p>Update date(更新日時)：<fmt:formatDate value="${task.updated_at}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
